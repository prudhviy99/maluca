    ...
    public static MalucaProperties properties(boolean trustXff, List<String> trustedProxies) {
        return new MalucaProperties(
                ...
                new MalucaProperties.Identity(trustXff, trustedProxies,
                        MalucaProperties.Identity.KeyStrategy.NETWORK, "session",
                        List.of("159.65.0.0/16", "3.0.0.0/9")),
                new MalucaProperties.Limits(true, com.maluca.model.RateLimitAlgorithm.FIXED_WINDOW,
                        30, 10, 3, 30, 300, 5),
                new MalucaProperties.Scoring(
                        new MalucaProperties.Scoring.Weights(40, 25, 20, 25, 15, 15, 60, 15, 8, 12, 10, 30, 20),
